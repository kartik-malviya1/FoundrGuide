      ...
      <div className="max-w-screen border border-b">
        <div className="flex items-center justify-evenly p-4">
          ...
          <div className="flex flex-col justify-evenly gap-3 text-sm">
            ...
            <p className="cursor-pointer hover:underline">Founder's Guide</p>
          ...
          <div className="flex flex-col justify-evenly gap-3 text-sm">
            <h2 className="mt-4 mb-2 font-semibold text-base">Stay Connected</h2>
        ...
        <div className="flex flex-col text-start gap-2 items-start rounded-xl p-6">
          ...
          <p>Join our newsletter to stay informed about updates and new features.</p>
          <form method="post" className="flex gap-2">
            <input type="email" name="email" className="bg-gray-50 p-2 px-6 rounded-md border hover:border-blue-600 border-black" placeholder="Enter your email"/>
            <Button variant={"outline"} size={"lg"} className="hover:border-blue-600 hover:text-blue-600 border border-black">Submit</Button>
          </form>
          <p className="text-xs">By subscribing, you agree to our Privacy Policy and consent to receive updates.</p>
        </div>
        </div>
      </div>
